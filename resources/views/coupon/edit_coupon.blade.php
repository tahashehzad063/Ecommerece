  ...
  @include('adminmain.sidebar')
     ...
     @include('adminmain.navbar')
        ...
        <div class="main-panel">
         ...
         @endif
         <form action="{{ url('/update_coupon',$product->id) }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code" value="{{$product->code}}" placeholder="Coupon Code">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="max_uses" value="{{$product->max_uses}}" id="max_uses" placeholder="Max Uses">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="email">Max_Uses_Users</label>
                        <input type="text" name="max_uses_users" id="max_uses_users" value="{{$product->max_uses_users}}"  placeholder="Max_uses_users">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{$product->discount_amount}}" name="discount_amount" id="discount_amount" placeholder="discount_amount">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="phone">min_amount</label>
                        <input type="text" value="{{$product->min_amount}}" name="min_amount" id="min_amount" placeholder="min_amount">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{$product->starts_at}}" name="starts_at" id="starts_at"  placeholder="starts_at">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="phone">expires_at</label>
                        <input type="text" value="{{$product->expires_at}}" name="expires_at" id="expires_at"  placeholder="expires_at">	
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
