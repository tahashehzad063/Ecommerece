        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('all_messages')}}">
              <span class="menu-icon">
                <i class="fa-regular fa-message" style="font-size: 24px"></i>
              </span>
              <span class="menu-title">Message By User</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{url('copun')}}">Add Coupon</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{url('show_coupon')}}">Show Coupon</a></li>
              </ul>
            </div>
          </li>
        </ul>
